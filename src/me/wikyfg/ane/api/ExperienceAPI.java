...
public class ExperienceAPI {
     ...
     */
    public ExperienceAPI(Player player) {
    ...
    public static void setHardMaxLevel(int hardMaxLevel) {
        ExperienceAPI.hardMaxLevel = hardMaxLevel;
    }
    ...
    /**
     * Get the Player associated with this @link ExperienceAPI.
     *
