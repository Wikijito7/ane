                ...
                if (p.isOp()) {
                    ...
                    if (pl != null || Files.userdata.contains(args[0])) {
                        if (Files.userdata.get(args[0] + ".jail").equals("true")) {
                            ...
                            if (pl != null)
                                pl.sendMessage(ChatColor.GREEN + "Te han liberado, no vuelvas a hacer lo que hiciste previamente si no quieres ser encanrcelado de nuevo.");
                            if (main.files != null){
                        ...
                        if (pl != null)
                            pl.sendMessage(ChatColor.DARK_RED + "Has sido encarcelado, piensa qué has hecho para llegar a esa situación.");
